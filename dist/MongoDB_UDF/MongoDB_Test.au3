...
Func _MongoRunTests()
	...
	; ($pMongocollection, $sQuery, $sUpdate, $sOptions = "{}")
	$sResult = _Mongo_UpdateOne($pMongocollection,'{"application":"ffastrans"}','{"$set":{"developers":["emcodem","FranceBB","momocampo"]}}','{"upsert":true}')
